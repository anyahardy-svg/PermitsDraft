          ...
          <>
            ...
            <TouchableOpacity style={[styles.primaryButton, { flex: 0.8, backgroundColor: '#3B82F6' }]} onPress={() => {
              ...
              const html = `
                <html>
                  <head>
                    <title>Permit #${item.permitNumber}</title>
                    <style>
                  ...
                  <body>
                    <h1>PERMIT TO WORK - #${item.permitNumber}</h1>
                    <div class="section">
                      <p><span class="label">Status:</span> ${item.status}</p>
                      <p><span class="label">Type:</span> ${item.permitType || item.type || 'N/A'}</p>
                      <p><span class="label">Location:</span> ${item.location}</p>
                      <p><span class="label">Priority:</span> ${item.priority}</p>
                      <p><span class="label">Requested By:</span> ${item.requestedBy}</p>
                    </div>
                    <div class="section">
                    ...
                    <div class="section">
                      <p><span class="label">Date:</span> ${item.submittedDate || 'N/A'}</p>
                    </div>
                    <p style="margin-top: 40px; font-size: 12px; color: #666;">Generated by Permit Management System</p>
                  </body>
                </html>
              `;
                ...
                <html>
                  <head>
                    ...
                    <style>
                      ...
                      .section { margin: 20px 0; border-bottom: 1px solid #ccc; padding-bottom: 10px; }
                      .label { font-weight: bold; color: #374151; }
                      .completed { background-color: #E8F5E9; padding: 10px; border-radius: 4px; }
                    </style>
                  </head>
                  <body>
                    <h1>PERMIT TO WORK - #${item.permitNumber}</h1>
                    <div class="section completed">
                      <p><span class="label">STATUS: COMPLETED</span></p>
                    </div>
                    <div class="section">
                      <p><span class="label">Type:</span> ${item.permitType || item.type || 'N/A'}</p>
                      <p><span class="label">Location:</span> ${item.location}</p>
                    ...
                    <div class="section">
                      <p><span class="label">Completed Date:</span> ${item.completedDate || 'N/A'}</p>
                      ${item.completedSignOff ? `
                        <p><span class="label">Issued By:</span> ${item.completedSignOff.issuerName || 'N/A'}</p>
                        <p><span class="label">Work Completed By:</span> ${item.completedSignOff.receiverName || 'N/A'}</p>
                      ` : ''}
                    </div>
                    <p style="margin-top: 40px; font-size: 12px; color: #666;">Generated by Permit Management System</p>
                  </body>
