                          ...
                          <View style={{ marginTop: 12, marginBottom: 12, backgroundColor: '#FEF3C7', padding: 12, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: '#F59E0B', overflow: 'visible', zIndex: 100, position: 'relative' }}>
                            ...
                            <View style={{ position: 'relative', marginBottom: 12, overflow: 'visible', zIndex: 9999 }}>
                              ...
                              {showHwSafetyWatchDropdown && filteredHwSafetyWatchContractors.length > 0 && (
                                <Modal
                                  visible={showHwSafetyWatchDropdown && filteredHwSafetyWatchContractors.length > 0}
                                  transparent={true}
                                  animationType="fade"
                                  onRequestClose={() => setShowHwSafetyWatchDropdown(false)}
                                >
                                  <TouchableOpacity 
                                    style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.1)', justifyContent: 'center', alignItems: 'center' }}
                                    activeOpacity={1}
                          ...
                          <View style={{ marginTop: 12, marginBottom: 12, backgroundColor: '#FEF3C7', padding: 12, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: '#F59E0B', overflow: 'visible', zIndex: 100, position: 'relative' }}>
                            ...
                            <View style={{ position: 'relative', marginBottom: 12, overflow: 'visible', zIndex: 9999 }}>
                              ...
                              {showCsSafetyWatchDropdown && filteredCsSafetyWatchContractors.length > 0 && (
                                <Modal
                                  visible={showCsSafetyWatchDropdown && filteredCsSafetyWatchContractors.length > 0}
                                  transparent={true}
                                  animationType="fade"
