...
const transformContractor = (dbContractor) => {
  ...
  return {
    ...
    companyManuallyEntered: dbContractor.company_manually_entered || false,
    company_manually_entered: dbContractor.company_manually_entered || false,
    createdAtBusinessUnitIds: dbContractor.created_at_business_unit_ids || [],
    created_at_business_unit_ids: dbContractor.created_at_business_unit_ids || [],
