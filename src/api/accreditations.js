  ...
  try {
    const { data, error } = await supabase
      ...
      .select(`
        ...
        ppe_compliance_exists,
        ppe_compliance_score,
        ppe_compliance_evidence_url,
        ...
        plant_equipment_onsite_exists,
        plant_equipment_onsite_score,
        plant_equipment_onsite_evidence_url,
        ...
        emergency_first_aid_exists,
        emergency_first_aid_score,
        emergency_first_aid_evidence_url,
