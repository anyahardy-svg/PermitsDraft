...
export const supplierSchema = {
  basicsSection: {
    ...
    fields: [
      ...
      { id: 'address_1', label: 'Street Address', type: 'text', placeholder: 'Enter street address here' },
      { id: 'address_city', label: 'City', type: 'text', placeholder: 'Enter city here' },
      { id: 'address_postcode', label: 'Postcode', type: 'text', placeholder: 'Enter postcode here' },
      {
  ...
  sections: [
    {
      ...
      fields: [
        { id: 'product_name', label: 'Product Name', type: 'text', required: true, placeholder: 'Enter product name here' },
        {
          id: 'product_type',
          label: 'Product Type',
          type: 'checkbox-list',
        ...
        { id: 'aligned_standards', label: 'Are test methods aligned to standards?', type: 'yes_no' },
        {
          ...
          type: 'text',
          placeholder: 'Enter applicable standards here (e.g., AS/NZS, ASTM)',
        ...
        {
          id: 'dosage_variance',
          label: 'What happens if dosage varies?',
          type: 'text',
          multiline: true,
          placeholder: 'Describe what happens if dosage varies here',
        },
        {
          ...
          type: 'text',
          multiline: true,
          placeholder: 'Describe limitations of use here',
        },
        {
        ...
        },
        {
          ...
          type: 'text',
          placeholder: 'Enter hazard classification here (if applicable)',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      type: 'group',
      fields: [
        { id: 'manufacturing_locations', label: 'Manufacturing location(s)', type: 'text', placeholder: 'Enter manufacturing location(s) here' },
        {
          id: 'production_type',
          label: 'Production',
          type: 'select',
          options: ['In-house', 'Outsourced'],
        ...
        },
        {
          ...
          type: 'text',
          multiline: true,
          placeholder: 'Describe how raw materials are checked before use here',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      type: 'group',
      fields: [
        { id: 'lead_time', label: 'Lead time', type: 'text', placeholder: 'Enter lead time here (e.g., 2-3 weeks)' },
        { id: 'supply_capacity', label: 'Supply capacity', type: 'text', placeholder: 'Enter supply capacity here' },
        { id: 'delivery_method', label: 'Delivery method', type: 'text', placeholder: 'Enter delivery method here' },
      ],
    },
    {
      ...
      fields: [
        ...
        { id: 'notice_period', label: 'Notice period', type: 'text', placeholder: 'Enter notice period here (e.g., 30 days)' },
      ],
    },
    {
      ...
      fields: [
        { id: 'product_complaints', label: 'Any product complaints/failures?', type: 'yes_no' },
        {
          ...
          type: 'text',
          multiline: true,
          placeholder: 'Provide a summary of product complaints or failures here',
    ...
    },
    {
      ...
      visibleWhen: (_formData, userRole) => userRole === 'admin',
      fields: [
        { id: 'supplier_dependency', label: 'Supplier dependency', type: 'select', options: ['High', 'Medium', 'Low'], placeholder: 'Select supplier dependency' },
        {
          id: 'availability_alternatives',
          label: 'Availability of alternatives',
          type: 'select',
          options: ['High', 'Medium', 'Low'],
          placeholder: 'Select availability of alternatives',
        },
        {
          id: 'final_decision',
