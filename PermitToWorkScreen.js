...
const PermitToWorkApp = () => {
  // Questionnaire definitions for each specialized permit
  const permitQuestionnaires = {
    ...
    hotWork: [
      ...
      { id: 'conveyors_nearby', text: 'Are there conveyors, rubber lined chutes and poly deck screens in the immediate area and/or below any hot work?', type: 'yesno_text', textLabel: 'If yes, cover in fire blankets, wet sacks, hose down etc.' },
      { id: 'wet_surfaces', text: 'Does floors and surface areas need to be wetted down?', type: 'yesno', required: true },
      { id: 'flammable_gases', text: 'Are flammable gases present in the area?', type: 'yesno', note: 'If yes, gas test required' },
      { id: 'confined_space', text: 'Is hot work being undertaken in a confined space?', type: 'yesno', note: 'If yes, Confined Space permit also required' },
      { id: 'hdpe_welding', text: 'Is High Density Polyethylene pipe being welded using electrofusion?', type: 'yesno', note: 'If yes, blank off open end and follow manufacturer cooling times' }
    ],
    ...
    electrical: [
      ...
      { id: 'isolation_requirements', text: 'Isolation requirements completed? Test and prove all isolations. Personal locks to be used and in place during the job.', type: 'yesno_text', textLabel: 'Describe isolation requirements', required: true },
      { id: 'signage', text: 'Signage required to be placed by job to warn of hazard?', type: 'yesno', required: true },
      { id: 'ladder_required', text: 'Will a ladder be required? If yes, non-metallic ladders to be used in switchyards and around live equipment.', type: 'yesno', required: true }
    ],
    ...
    workingAtHeight: [
      ...
      { id: 'fall_prevention', text: 'Best fall prevention methods assessed and put in place?', type: 'yesno_text', textLabel: 'Describe prevention methods', required: true },
            ...
            <View style={styles.radioGroup}>
              {['yes', 'no', 'na'].map(option => (
                ...
                >
                  <View style={[
                    styles.radioCircle,
                    (currentValue === option || (option === 'yes' && currentValue.startsWith('yes'))) && styles.radioSelected
                  ]} />
                  <Text style={styles.radioLabel}>{option.toUpperCase()}</Text>
                </TouchableOpacity>
              ))}
            </View>
            {(currentValue.startsWith('yes') || currentValue.includes('|')) && (
  ...
  const submitPermit = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Submit', onPress: () => Alert.alert('Success', 'Permit submitted for approval') }
      ]
    );
  };
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>Permit to Work System</Text>
          <Text style={styles.subtitle}>Enhanced with Specialized Permits & JSEA</Text>
        </View>
              ...
              <View style={styles.inputRow}>
                <View style={styles.inputHalf}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) => setFormData({...formData, permitNumber: text})}
                  />
                </View>
                <View style={styles.inputHalf}>
        ...
        <View style={styles.section}>
          ...
          >
            <Text style={[styles.sectionTitle, styles.dangerTitle]}>Specialized Permits Required</Text>
...
export default PermitToWorkApp;